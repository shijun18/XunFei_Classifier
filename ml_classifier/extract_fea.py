...
def extract_features(input_csv,save_csv):
    grey_features = ['contrast','dissimilarity','homogeneity','correlation','ASM','energy']
...
if __name__ == "__main__":
  ...
  input_csv = '../converter/csv_file/test_temp_freq.csv'
  save_csv = './test_temp_freq_features.csv'
