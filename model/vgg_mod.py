...
def mod_vgg11(pretrained=False, progress=True, **kwargs):
...
def mod_vgg13(pretrained=False, progress=True, **kwargs):
...
def mod_vgg16(pretrained=False, progress=True, **kwargs):
...
def mod_vgg19(pretrained=False, progress=True, **kwargs):
