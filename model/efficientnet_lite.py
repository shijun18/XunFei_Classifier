...
class EfficientNetLite(nn.Module):
    def __init__(self, widthi_multiplier, depth_multiplier, num_classes, drop_connect_rate, dropout_rate, input_channels=3):
...
def efficientnet_lite0(num_classes,input_channels,pretrained=False,progress=True):
    arch_name = 'efficientnet_lite0'
    width_coefficient, depth_coefficient, _, dropout_rate = efficientnet_lite_params[arch_name]

    if pretrained:
        assert input_channels == 3
        model = EfficientNetLite(width_coefficient, depth_coefficient, 1000, 0.2, dropout_rate,3)
        state_dict = load_state_dict_from_url(model_urls[arch_name],progress=progress)
        model.load_state_dict(state_dict)
        model.fc = nn.Linear(1280, num_classes)
    
    else:
        model = EfficientNetLite(width_coefficient, depth_coefficient, num_classes, 0.2, dropout_rate,input_channels)

    return model


def efficientnet_lite1(num_classes,input_channels,pretrained=False,progress=True):
    arch_name = 'efficientnet_lite1'
    width_coefficient, depth_coefficient, _, dropout_rate = efficientnet_lite_params[arch_name]
...
def efficientnet_lite2(num_classes,input_channels,pretrained=False,progress=True):
    arch_name = 'efficientnet_lite2'
    width_coefficient, depth_coefficient, _, dropout_rate = efficientnet_lite_params[arch_name]
...
def efficientnet_lite3(num_classes,input_channels,pretrained=False,progress=True):
    arch_name = 'efficientnet_lite3'
    width_coefficient, depth_coefficient, _, dropout_rate = efficientnet_lite_params[arch_name]
...
def efficientnet_lite4(num_classes,input_channels,pretrained=False,progress=True):
    arch_name = 'efficientnet_lite4'
    width_coefficient, depth_coefficient, _, dropout_rate = efficientnet_lite_params[arch_name]
...
if __name__ == '__main__':
    net = efficientnet_lite0(2,3,True)
