...
def _resnet(arch, block, layers, pretrained, progress, **kwargs):
    ...
    model.fc = nn.Linear(2*512 * block.expansion, kwargs['num_classes'])
    return model


def finenet18(pretrained=False, progress=True, **kwargs):
...
def finenet34(pretrained=False, progress=True, **kwargs):
...
def finenet50(pretrained=False, progress=True, **kwargs):
...
def finenet101(pretrained=False, progress=True, **kwargs):
...
def finenet152(pretrained=False, progress=True, **kwargs):
